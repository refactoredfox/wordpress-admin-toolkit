...
if ( !class_exists( 'RF_Admin_Toolkit_Display' ) ) {

	class RF_Admin_Toolkit_Display
	{
		...
		public static function create_field($args)
		{
			...
			$args['options'] = array_map( 'RF_Admin_Toolkit_Display::clear_text', $args['options'] );

			switch( $args['type'] ){
				case 'dropdown':
					$html = RF_Admin_Toolkit_Display::create_dropdown($args);
				break;

				case 'm_dropdown':
					$html = RF_Admin_Toolkit_Display::create_multidropdown($args);
				break;

				case 'checkbox':
					$html = RF_Admin_Toolkit_Display::create_checkbox($args);
				break;

				case 'text':
					$html = RF_Admin_Toolkit_Display::create_text($args);
				break;

				case 'textarea':
					$html = RF_Admin_Toolkit_Display::create_textarea($args);
				break;

				case 'radio':
					$html = RF_Admin_Toolkit_Display::create_radio($args);
				break;

				case 'range':
					$html = RF_Admin_Toolkit_Display::create_range($args);
				break;

				case 'date':
					$html = RF_Admin_Toolkit_Display::create_date($args);
				break;

				case 'custom_user':
					$html = RF_Admin_Toolkit_Display::create_users($args);
				break;

				case 'custom_post':
					$html = RF_Admin_Toolkit_Display::create_posts($args);
				break;
		...
		public static function create_dropdown( $args )
		{
			...
			$values = array_map( 'RF_Admin_Toolkit_Display::clear_text', $values );
		...
		{
			$value = RF_Admin_Toolkit_Display::clear_text($args['values']);
			$html = '<input';
			$html .= $args['class'] ? ' class="'.$args['class'].'" ' : '';
			foreach( $args['data'] as $k => $v ){
				$html .= ' data-'.$k.'="'.$v.'"';
		...
		{
			$values = RF_Admin_Toolkit_Display::clear_text($args['values']);
